...
const Client = () => {
    ...
    return (
    <div className="2xl:px-20 md:px-10 2xl:mx-auto 2xl:container" style={{paddingLeft: "25px", paddingRight: "25px"}}>
            <div className="md:py-12 py-8 px-4">
                <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-base leading-normal text-center text-gray-600 mt-4 xl:w-1/2 w-10/12">Our years of experience in the industry paired with a client-oriented approach not only gives us an edge against the competition but it allows us to achieve remarkable results consistently. Now, we boast an extensive list of clientele, with brands reaching out from far and wide, more locally, to take advantage of our unparalleled services - and you can be one of them.</p>
                </div>
