            ...
            <div className="w-full bg-white py-12">
                <div className="container mx-auto">
                    ...
                    <div className="w-11/12 mx-auto">
                                ...
                                <table className="sm:table-fixed table-auto w-full bg-white">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td className="w-3/12 border border-gray-200 p-2 sm:p-4 text-center text-xs sm:text-sm text-gray-800">R1499</td>
                                            <td className="w-3/12 border border-gray-200 p-2 sm:p-4 text-center text-xs sm:text-sm text-gray-800">R2499</td>
                                            <td className="w-3/12 border border-gray-200 p-2 sm:p-4 text-center text-xs sm:text-sm text-gray-800">R3499</td>
                                            <td className="w-3/12 border border-gray-200 p-2 sm:p-4 text-center text-xs sm:text-sm text-gray-800">R4999</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <h2 className="xl:text-4xl text-3xl text-center text-gray-800 mb-4 font-extrabold" style={{fontSize: "16px", paddingTop: "80px"}}>UI / UX Design Pricing</h2>
                        <div>
                            <div className="flex items-center w-full">
                                    <p className="pl-4 pt-3 pb-3 font-bold text-sm text-gray-600 w-3/12">Pricing</p>
                                    <p className="w-3/12 text-sm text-center text-gray-800 font-bold lg:hidden">Starter</p>
