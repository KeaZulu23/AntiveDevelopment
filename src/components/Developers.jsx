                    ...
                    <div className="lg:flex md:flex sm:flex items-center xl:justify-between flex-wrap md:justify-around sm:justify-around lg:justify-around">
                        <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
                            <div className="rounded overflow-hidden shadow-md bg-white">
                                ...
                                <div className="px-6 mt-16">
                                    <div className="font-bold text-3xl text-center pb-1">Keabetsoe Zulu</div>
                                    <p className="text-gray-800 text-sm text-center">Lead Full-Stack Developer</p>
                                    <div className="w-full flex justify-center pt-5 pb-5">
                                        <a href="https://github.com/KeaZulu23" className="mx-5">
                                            <div>
                                        ...
                                        <a href="https://instagram.com/antive_dev?utm_medium=copy_link" className="mx-5">
                                            <div>
                        ...
                        <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
                            <div className="rounded overflow-hidden shadow-md bg-white">
                                <div className="absolute -mt-20 w-full flex justify-center">
                                    <div className="h-32 w-32">
                                        <img src={"https://media.istockphoto.com/id/512903672/vector/work-addict-geek-sitting-at-the-computer-desk.jpg?s=612x612&w=0&k=20&c=2tEkml6KIQ_pXi95RhwoTb2_gl7Pg1N19m1EVbkap0s="} alt className="rounded-full object-cover h-full w-full shadow-md" />
                                    </div>
                                </div>
                                <div className="px-6 mt-16">
                                    <div className="font-bold text-3xl text-center pb-1">Boitumelo Tshoenyane</div>
                                    <p className="text-gray-800 text-sm text-center">Lead UI/UX Designer</p>
                                    <div className="w-full flex justify-center pt-5 pb-5">
