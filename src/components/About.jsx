...
const About = () => {
  const features = [
    ...
    },
    {
      ...
      description:
        'Need an app to increase sales, improve efficiency, improve productivity, increase workforce flexibility or to be a market disruptor?',
  ...
  return (
    <div className="py-12 bg-white" style={{paddingLeft: "20px", paddingRight: "20px"}}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
          ...
          Antive Development is an end-to-end custom software development company that designs, builds, deploys and maintains mobile and web applications. ;)
          </p>
        </div>
      ...
      <p className="font-normal text-sm leading-3 text-indigo-700 hover:text-indigo-800 cursor-pointer pb-2">About</p>
        <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
          <div className="w-full lg:w-6/12">
            ...
            <p className="font-normal text-base leading-6 text-gray-600 mt-6">We create perfect brands, build outstanding websites and vibrant identities and inspire creative concepts. We make your brand, concept, web site and identity into a digital legend recalled throughout the ages of digital.</p>
          </div>
        <div className="w-full lg:w-6/12">
    ...
    <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
        <div>
            ...
            <p className="font-normal text-base leading-6 text-gray-600 mt-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
        </div>
        <div>
            <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">650M+ Monthly Users</p>
            <p className="font-normal text-base leading-6 text-gray-600 mt-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
        </div>
        <div className="sm:block hidden">
            <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">1B+ Users</p>
            <p className="font-normal text-base leading-6 text-gray-600 mt-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
        </div>
    </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
                ...
                <div className="flex p-4 shadow-md">
                    ...
                    <div className="">
                        ...
                        <p className="mt-2 font-normal text-base leading-6 text-gray-600">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                    </div>
                </div>
